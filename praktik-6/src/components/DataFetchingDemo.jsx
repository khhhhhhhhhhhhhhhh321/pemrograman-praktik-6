...
const DataFetchingDeso = () => {

    const [users, setüsers] = useState([]);
    const [loading, setLoading] = useState(true);
    const [error, setError] = useState(null);
    const [userId, setUserld] = useState(1);
    ...
    const handleUserChange = (event) => {
        setUserld(parseInt(event.target.value));
    };
...
export default DataFetchingDeso;
